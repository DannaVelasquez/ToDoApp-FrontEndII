...
- [ ] FUNCIÓN 1: Escuchar el submit y preparar los datos para elenvío. OK
- [ ] FUNCIÓN 2: Realizar la petición a la API para ingresar si los datos del usuario son correctos. OK
